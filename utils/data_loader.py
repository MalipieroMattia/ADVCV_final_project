...
class DatasetManager:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.data_root = (
            os.environ.get("UCLOUD_DATA_PATH") 
            or self.data_config.get("root", "raw_data/Data_YOLO")
        )
    ...
    def create_data_yaml(
        ...
        test_path = self.data_config.get("test_images")
        if test_path:
    ...
    def _stratified_split(
        ...
        # Create output directory (in temp or data directory)
        output_dir = self.data_root.parent / f"{self.data_root.name}_split"
